...
function LoginModal(props) {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer>
        <Button className="login-modal-close-btn" onClick={props.onHide}>
          닫기
        </Button>
      </Modal.Footer>
    </Modal>
  ...
  return (
    <div className="social-login">
      <a className="btn btn-block social-btn google" href={GOOGLE_AUTH_URL}>
        <img src="../imgs/google-logo.png" alt="Google" /> Google 계정으로
        로그인
      </a>
      <a className="btn btn-block social-btn kakao" href={KAKAO_AUTH_URL}>
        <img src="../imgs/kakao-logo.png" alt="Kakao" /> Kakao 계정으로 로그인
      </a>
      <a className="btn btn-block social-btn kakao" href={NAVER_AUTH_URL}>
        <img src="../imgs/naver-logo.png" alt="Naver" /> Naver 계정으로 로그인
      </a>
    </div>
  );
}
